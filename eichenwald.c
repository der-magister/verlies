...
void p_lvl120 (void) __banked
{
	...
	if (v_smk == 124)
	{
		p_engine_loadMap (v_lvl121, BANK_6, BANK_16);
                p_engine_changeLvl (121, 16, 72);
	}
	else if (v_smk == 10)
	{
		p_engine_loadMap (v_lvl123, BANK_6, BANK_16);
...
void p_lvl121 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl122, BANK_6, BANK_16);
...
void p_lvl123 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl124, BANK_6, BANK_16);
		p_engine_changeLvl (124, 16, 56);
	}
	else if (v_smk == 108)
	{
		p_engine_loadMap (v_lvl127, BANK_6, BANK_16);
...
void p_lvl124 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl125, BANK_6, BANK_16);
...
void p_lvl125 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl126, BANK_6, BANK_16);
...
void p_lvl127 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl128, BANK_6, BANK_16);
		p_engine_changeLvl (128, 144, 72);
	}
	else if (v_smk == 12)
	{
		p_engine_loadMap (v_lvl129, BANK_6, BANK_16);
...
void p_lvl129 (void) __banked
{
	...
	if (v_smk == 4)
	{
		p_engine_loadMap (v_lvl130, BANK_6, BANK_16);
...
void p_lvl130 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl131, BANK_6, BANK_16);
...
void p_lvl131 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl132, BANK_6, BANK_16);
...
void p_lvl132 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl133, BANK_6, BANK_16);
...
void p_lvl133 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl134, BANK_6, BANK_16);
...
void p_lvl134 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl135, BANK_6, BANK_16);
...
void p_lvl135 (void) __banked
{
	...
	{	
		p_engine_loadMap (v_lvl136, BANK_6, BANK_16);
		p_engine_changeLvl (136, 64, 24);
	}
	else if (v_smk == 124)
	{
		p_engine_loadMap (v_lvl140, BANK_6, BANK_16);
...
void p_lvl136 (void) __banked
{
	...
	{
		p_engine_loadMap (v_lvl137, BANK_6, BANK_16);
		p_engine_changeLvl (137, 144, 56);
	}
	else if (v_smk == 222)
	{
		p_engine_loadMap (v_lvl138, BANK_6, BANK_16);
		p_engine_changeLvl (138, 64, 24);
		p_gui_show_location (lelfenhain);
	}
	else if (v_smk == 124)
	{
		p_engine_loadMap (v_lvl139, BANK_6, BANK_16);
