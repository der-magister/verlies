...
void p_lvl_whichLvL (void) BANKED
{
	if (v_lvl == 1) p_lvl1 ();
        ...
        else if (v_lvl == 266) p_lvl266 ();
        else if (v_lvl == 267) p_lvl267 ();
...
void p_lvl_status (void) BANKED
{
	...
	else if (v_lvl == 13)
	{
        ...
        else if (v_lvl == 51)
        {
                ...
                if (v_tuer [2] == 1) {
                        v_tile [0] = 42;
                        p_engine_set_tile (4, 12, 1);
                        v_tile [0] = 40;
                        p_engine_set_tile (5, 12, 1);
                        v_tile [0] = 39;
                        p_engine_set_tile (4, 13, 1);
                        v_tile [0] = 41;
                        p_engine_set_tile (5, 13, 1);
                }       
        }
	...
	else if (v_lvl == 86)
	{
		if (v_questen [0] > 12)
		{
			...
			p_engine_set_tile (1, 7, LAYER_BKG);
                ...
                if (v_questen [0] > 15) {
                        p_engine_set_tile (4, 11, LAYER_BKG);
                        p_engine_set_tile (5, 11, LAYER_BKG);
                }
        }
        else if (v_lvl == 236) {
                if (v_questen [0] > 14) {
