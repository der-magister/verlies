...
{
        if (v_info == TRUE) p_hud_umwandlung (v_slp, 3, 1, 2);
...
{
  p_hud_umwandlung (v_sgo % 10, 18, 1, 2);
  p_hud_umwandlung ((v_sgo / 10) % 10, 17, 1, 2);
