...
void p_spieler_init () BANKED
{
        ...
        v_smlp = 3; v_slp = v_smlp; v_srs = 0; v_stp = 0;
        v_sht = 0; v_smht = 3; v_sgo = 0; v_smgo = 15; v_spr = 5; v_smpr = 5; v_ske = 0; v_hk = 0; v_mhk = 2;
        v_ssc = 0; v_sstaub = 0; v_smstaub = 0; v_portalrune = FALSE;
        v_spitzhacke = FALSE; //v_selectItem = 0;
        v_walk = TRUE;
}
...
///Kolisionsprüfung Spieler
/*UINT8 p_spieler_koli () BANKED
{
        for (v_a = 0; v_a != 25 ; ++v_a)
        {
                if (v_tile [1] == v_kdat [v_lvl - 1][v_a]) { return FALSE; }
                else { return TRUE; }
        }
}*/
