...
#include "daten/lvl/v_lvl21.h"
#include "daten/lvl/v_lvl22.h"
#include "daten/lvl/v_lvl22b.h"
#include "daten/lvl/v_lvl24.h"
#include "daten/lvl/v_lvl25.h"
#include "daten/lvl/v_lvl26.h"
#include "daten/lvl/v_lvl27.h"
#include "daten/lvl/v_lvl28.h"
#include "daten/lvl/v_lvl29.h"
#include "daten/lvl/v_lvl31.h"
#include "daten/lvl/v_lvl30.h"
#include "daten/lvl/v_lvl32.h"
#include "daten/lvl/v_lvl33.h"
#include "daten/lvl/v_lvl34.h"
#include "daten/lvl/v_lvl35.h"
#include "daten/lvl/v_lvl36.h"
#include "daten/lvl/v_lvl37.h"
#include "daten/lvl/v_lvl38.h"
#include "daten/lvl/v_lvl39.h"
#include "daten/lvl/lvldatogerhoehlen.h"
#include "daten/lvl/v_lvl70.h"
#include "daten/lvl/v_lvl71.h"
#include "daten/lvl/v_lvl72.h"
#include "daten/lvl/v_lvl73.h"
#include "daten/lvl/v_lvl74.h"
#include "daten/lvl/v_lvl75.h"
#include "daten/lvl/v_lvl76.h"
#include "daten/lvl/v_lvl77.h"
#include "daten/lvl/v_lvl78.h"
#include "daten/lvl/v_lvl79.h"
#include "daten/lvl/v_lvl15.h"
#include "daten/lvl/v_lvl16.h"
#include "daten/lvl/v_lvl17.h"
#include "daten/lvl/v_lvl18.h"
#include "daten/lvl/v_lvl80.h"
#include "daten/lvl/v_lvl81.h"
#include "daten/lvl/v_lvl82.h"
#include "daten/lvl/v_lvl83.h"
#include "daten/lvl/v_lvl84.h"
#include "daten/lvl/v_lvl85.h"
#include "daten/lvl/v_lvl86.h"
#include "daten/lvl/v_lvl87.h"
...
void p_lvl36 () __banked
{
	p_busch (188, 1);
        ...
        if (v_keyflag == 1)
        {
                ...
                {
			p_engine_loadMap (v_lvl78, BANK_6, BANK_16);
...
void p_lvl78 () __banked
{
	if (v_smk == 126)
        {
                p_engine_loadMap (v_lvl79, BANK_6, BANK_16);
...
void p_lvl79 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl15, BANK_6, BANK_16);
...
void p_lvl16 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl17, BANK_6, BANK_16);
                p_engine_changeLvl (17, 16, 48);
        }
        else if (v_smk == 108)
        {
                p_engine_loadMap (v_lvl84, BANK_6, BANK_16);
...
void p_lvl17 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl18, BANK_6, BANK_16);
...
void p_lvl18 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl80, BANK_6, BANK_16);
...
void p_lvl80 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl81, BANK_6, BANK_16);
...
void p_lvl82 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl83, BANK_6, BANK_16);
...
void p_lvl84 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl85, BANK_6, BANK_16);
...
void p_lvl85 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl86, BANK_6, BANK_16);
...
void p_lvl86 () __banked
{
        ...
        {
                p_engine_loadMap (v_lvl87, BANK_6, BANK_16);
